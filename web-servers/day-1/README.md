...
#### Start nginx
<img width="1914" height="809" alt="image" src="https://github.com/user-attachments/assets/b99fa21a-2218-433c-bc7b-bb847db30a17" />

#### Intentional Misconfig & Reload
<img width="1857" height="785" alt="image" src="https://github.com/user-attachments/assets/d29ec5cd-77ba-4446-a14f-f1c5ce0dff39" />

#### Enable nginx
<img width="1669" height="460" alt="image" src="https://github.com/user-attachments/assets/bf792fc7-28af-4a61-a436-f6d41d823323" />

#### Restart nginx
<img width="1916" height="761" alt="image" src="https://github.com/user-attachments/assets/5cb1edc8-2409-4fe1-914b-40db4a1a9d23" />

## T2 - Explore the NGINX config hierarchy - Configuration Structure

### worker_processes and worker_connections

#### worker_processes defines number worker processes that will be created by Nginx to process requests.

#### when its value is set to 'auto', number of worker processes are created as many as cpu cores are available.
<img width="998" height="84" alt="image" src="https://github.com/user-attachments/assets/f6be6c9e-0f3b-422d-8b1a-88415cc8b5dc" />

#### worker_connections defines maximum number of simultaneous connections a single worker process can open.
<img width="1047" height="82" alt="image" src="https://github.com/user-attachments/assets/7c8b7798-2bec-4990-85d9-e9078d06b184" />
